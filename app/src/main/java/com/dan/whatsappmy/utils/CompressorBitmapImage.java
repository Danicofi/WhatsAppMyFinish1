...
public class CompressorBitmapImage {
    ...
    public static File reduceImageSize(File file, Context context) {
        try {
            ...
            file.createNewFile();
            FileOutputStream outputStream = context.openFileOutput("Bitmap.CompressFormat.JPEG", Context.MODE_PRIVATE);
